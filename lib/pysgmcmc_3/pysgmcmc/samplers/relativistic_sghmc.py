...
class RelativisticSGHMCSampler(MCMCSampler):
    ...
    def __init__(self, params, cost_fun, tf_scope="default", batch_generator=None,
                 ...
                 mass=1.0, speed_of_light=0.5, D=1.0, Bhat=0.0,
        ...
        super().__init__(
            ...
            tf_scope=tf_scope, stepsize_schedule=stepsize_schedule,
        ...
        for i in range(len(params)):
            ...
            for momentum_sample in _sample_relativistic_momentum(
                m=mass, c=speed_of_light, n_params=self.vectorized_params[i].shape[0], seed=self.seed
            ):
                momentum_params.append(momentum_sample)

            momentum_params = tf.reshape(momentum_params, self.vectorized_params[i].shape)
